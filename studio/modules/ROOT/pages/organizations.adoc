...
. Navigate to the link:https://app.mode.com/home/[{product} home page,window=_blank] and click on your name in the upper left corner of the window.
...
. Navigate to the link:https://app.mode.com/home/[{product} home page,window=_blank] for the Workspace where you would like to create the group.
...
. Navigate to the link:https://app.mode.com/home/[{product} home page,window=_blank], click on your name in the upper left corner of the screen, and select *Workspace Settings* from the dropdown menu.
...
To update your profile, start by navigating to the link:https://app.mode.com/home/[{product} home page,window=_blank] and signing in if you aren't already:
...
. From the {product} homepage, click on your account dropdown menu in the upper left.
. Click *Account*.
. Click on *Profile* under Account Settings.
...
. Navigate to your link:https://app.mode.com/home/[{product} homepage,window=_blank].
. Click on your name in the upper left corner.
. Click *Workspace Settings* from the dropdown menu.
...
. Navigate to the link:https://app.mode.com/home/[{product} home page,window=_blank].
