...
For example, if the {product} slack bot is not in the private #sales-only channel, then no member of your {product} organization can xref:report-scheduling-and-sharing.adoc#slack[share Reports from {product}] to the #sales-only channel.
...
Now all members of your organization can xref:report-scheduling-and-sharing.adoc#slack[share Reports to your Slack workspace] directly from the {product} interface.
...
See the full documentation for sharing data in {product} xref:sharing-and-embedding.adoc#sharing[here].
