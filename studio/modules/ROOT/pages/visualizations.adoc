...
You can toggle on and off either or both Column Grand totals and Subtotals and Row Grand totals and Subtotals using the xref:explorations.adoc#toolbar[Toolbar].
