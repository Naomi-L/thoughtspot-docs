...
The link:https://wordpress.org/plugins/mode-analytics/[{product} Wordpress plugin,window=_blank] allows you to easily White-Label Embed an {product} report into a WordPress site.

//The link:https://wordpress.org/plugins/mode-analytics/[{product} Wordpress plugin,window=_blank] allows you to easily xref:white-label-embeds.adoc[White-Label Embed] an {product} report into a WordPress site.
...
* The {product} Workspace containing the target Report must be on a link:https://mode.com/compare-plans/[paid plan,window=_blank] that includes White-Label Embeds.

//* The {product} Workspace containing the target report must be on a link:https://mode.com/compare-plans/[paid plan,window=_blank] that includes xref:white-label-embeds.adoc[White-Label Embeds].
...
=== Install the {product} WordPress plugin

Log in to your WordPress dashboard to install the {product} Wordpress plugin:

. In the left navigation panel, click *Plugins*, and then *Add New*.
. Search for *{product} Analytics* and the latest version will appear at the top of the list of results.
. Click *Install Now*.
. Wait for the installation to finish, then click *Activate*.

=== Input your {product} signature token

In the WordPress dashboard, go to *Settings* \-> *{product} Analytics*.
...
With <<install-the-mode-wordpress-plugin,{product}'s WordPress plugin>>, admins can set up user authentication Parameters or tokens.
...
_Make sure that the value you insert to substitute the token is the same value that you've assigned in your {product} Report._

=== Add token parameter into a report in WordPress

. Go to *Settings*, then *{product} Analytics*.
. In the Parameter section of the Report, enter the following:
 ** *Parameter Slug:* The same Parameter you used in the {product} Report.
