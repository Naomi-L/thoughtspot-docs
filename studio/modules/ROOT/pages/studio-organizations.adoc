...
* Any Report in your xref:studio-spaces.adoc#types-of-spaces[personal Collection] will remain in your personal Collection and remain accessible by any member of the Workspace in possession of the report URL.
...
xref:studio-workspace-api-tokens.adoc[See here for more information on Workspace API tokens].
...
Everyone on the internet can access your {product} Workspace's public profile page (for example, https://app.mode.com/modeanalytics) as well as the reports in your Workspace's xref:studio-spaces.adoc#community-space[community Collection].
In addition, all {product} users can access any data uploaded by members of your Workspace to xref:studio-managing-database-connections.adoc#mode-public-warehouse[{product}'s Public Warehouse].
...
Your Workspace includes a number of built-in xref:studio-report-layout-and-presentation.adoc#colors-and-themes[themes] which you may be able to compliment with custom themes.
...
Your Workspace includes a number of pre-defined xref:studio-report-layout-and-presentation.adoc#colors-and-themes[color palettes] which you may be able to compliment with additional custom color palettes.
...
Please reach out to your account manager or xref:studio-contact-us.adoc[contact our success team] for more information.
