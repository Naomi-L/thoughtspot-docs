...
To send an invitation, start from the link:https://app.mode.com/home/[{product} home page,window=_blank] for your Workspace, click on your name in the upper left corner, and then click *Invite to {product}*.
...
To create a new Report, click the *new Report* image:modal-add.svg[modal add] button in the upper right-hand corner of the link:https://app.mode.com/home/[{product} home page,window=_blank], which will take you the Query Editor, where you can compose SQL code.
