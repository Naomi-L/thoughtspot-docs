...
You can learn more about using Report filters in this xref:studio-interactivity.adoc#filters-and-parameters[article].

You can learn more about using the Report Builder in this xref:studio-report-layout-and-presentation.adoc#report-builder[article].
...
Learn more about sharing Reports in this xref:studio-report-scheduling-and-sharing.adoc[article].
