...
You can include Parameter values in a Report's xref:report-layout-and-presentation.adoc#url-query-string[URL query string] and {product} will return the Report's output using those values.
