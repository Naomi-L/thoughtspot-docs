...
Disabling this setting will immediately cause all xref:studio-report-scheduling-and-sharing.adoc#link[external links] to all Reports in your Workspace to stop functioning and return a `404 - Not Found` error.
...
xref:studio-contact-us.adoc[Contact our success team] to learn more.
...
Disabled by default.
Enable to make the xref:studio-spaces.adoc#community-space[community Collection] visible to all members of your Workspace and allow users to move Reports into it.
...
NOTE: {product} will be sunsetting the legacy Slack integration in September 2022. To upgrade your workspace to the latest Slack integration version, follow the instructions xref:studio-slack.adoc[here].
...
Set up your xref:studio-slack.adoc#setting-up[Slack Integration] today and xref:studio-report-scheduling-and-sharing.adoc#slack[start sharing].
