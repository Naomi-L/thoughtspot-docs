...
. Navigate to the link:https://app.mode.com/home/[{product} home page,window=_blank] and (if necessary) sign in to {product}.
...
To see a list of all the starred Reports, regardless of where they live, click on *Starred* on the left side of your link:https://app.mode.com/home/[{product} home page,window=_blank].
