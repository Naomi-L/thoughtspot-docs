...
When you explore in a Report with xref:interactivity.adoc#filters-and-parameters[filters], {product} will translate the relevant filters into your Exploration automatically.
...
To return to any Explorations you've made and or view all of your saved Explorations, go to the *My Explorations* tab on the left side of your link:https://app.mode.com/home/[{product} home page,window=_blank].
