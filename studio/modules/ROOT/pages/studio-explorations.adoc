...
When you explore in a Report with xref:studio-interactivity.adoc#filters-and-parameters[filters], {product} will translate the relevant filters into your Exploration automatically.
