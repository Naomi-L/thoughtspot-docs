...
For those who want to explore their data visually, Visual Explorer is a more flexible and powerful alternative to our "`fixed view`" xref:studio-visualizations.adoc#built-in-charts-and-tables[Quick Charts].
