...
You can include Parameter values in a Report's xref:studio-report-layout-and-presentation.adoc#url-query-string[URL query string] and {product} will return the Report's output using those values.
...
NOTE: A Parameter value provided via the Report's xref:studio-report-layout-and-presentation.adoc#url-query-string[URL query string] will override the default value.
