...
. Navigate to the link:https://app.mode.com/home/[{product} home page,window=_blank] for the Workspace to which you'd like to add the connection, and click on your name in the top left corner.
